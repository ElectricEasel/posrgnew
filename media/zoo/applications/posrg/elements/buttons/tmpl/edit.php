...
<div id="<?php echo $id; ?>">
	...
	<div class="more-options">
		...
		<div class="advanced options">
			...
			<div class="row">
				<?php echo $this->app->html->_('control.text', 'elements['.$element.']['.$index.'][custom_description]', $description, 'size="60" title="'.JText::_('Description').'" placeholder="'.JText::_('Description').'"'); ?>
			</div>
