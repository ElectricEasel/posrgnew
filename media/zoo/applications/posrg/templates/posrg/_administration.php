	...
	<div class="floatbox">
		...
		<div class="width50">
			...
			<div class="element">
                ...
                <?php $state = ($_GET['item_id']) ? $this->form->getTaintedValue('state') : 1; ?>
				<?php echo $this->app->html->_('select.booleanlist', 'state', '', $state); ?>
			...
			<div class="element element-publish_up<?php echo ($this->form->hasError('publish_up') ? ' error' : ''); ?>" style="display:none;">
			...
			<div class="element element-publish_down<?php echo ($this->form->hasError('publish_down') ? ' error' : ''); ?>" style="display:none;">
				<?php
		...
		<div class="width50">
			...
			<div class="element">
				...
				<div><?php echo $this->app->html->_('zoo.categorylist', $this->application, array(), 'categories[]', 'size="15"', 'value', 'text', $this->form->getTaintedValue('categories')); ?></div>
